-- Ingest lookup helpers for REST URL expansion
...
/**
 * Return distinct binding tuples as a JSON array of objects.
 * jsonb columns → text via #>> '{}'; other types → ::text.
 */
...
-- Update REST connector type schema for path templates + lookup flags
update public.connector_types
set
  description = 'Fetch JSON from a REST endpoint. Supports API key/bearer auth, paging, and optional URL expansion from ingest tables.',
  config_schema = '{
    "type": "object",
